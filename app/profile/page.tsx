...
export default async function ProfilePage() {
  ...
  const appointments = await getFutureAppointments(sessionUser.id)
    ...
    <main className="mx-auto w-full max-w-5xl px-4 pb-24 pt-6 sm:px-6">
      ...
      <section className="mt-6 rounded-3xl border border-border/50 bg-card p-6 shadow-sm">
        <div className="flex items-center justify-between gap-4">
          ...
          <Link href="/profile/edit" className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-muted hover:bg-muted/80">
